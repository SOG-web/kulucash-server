...
-- AlterTable
ALTER TABLE "UserProperties" ADD COLUMN     "collector_due_date" TEXT,
ADD COLUMN     "customer_service_call_time" TEXT,
ADD COLUMN     "customer_service_due_date" TEXT,
ADD COLUMN     "telemarketer_due_date" TEXT,
ADD COLUMN     "verificator_due_date" TEXT,
ALTER COLUMN "telemarketer_handler_id" DROP NOT NULL,
